...
cli.width = 80
cli.with {
   u(longOpt: 'user', args: 1, 'db username')
   p(longOpt: 'password', args: 1, 'db password')
   P(longOpt: 'port', args: 1, 'db port')
   d(longOpt: 'database', args: 1, 'database to migrate')
   H(longOpt: 'host', args: 1, 'Host database is running on')
   m(longOpt: 'migrations', args: 1, 'location of migration files')
